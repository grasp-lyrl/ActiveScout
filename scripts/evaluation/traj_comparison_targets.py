...
# plot trajectories
ax.plot(
    a_traj["agent-%d" % 0][start:step, 0],
    a_traj["agent-%d" % 0][start:step, 1],
    color=s_colors[0],
    # alpha=0.4,
    # label='trajectory'
)
for jj in range(num_targets):
    ax.plot(
        t_traj["targ-%d" % jj][start:step, 0],
        t_traj["targ-%d" % jj][start:step, 1],
        color=colors[jj],
        # alpha=0.4,
    )
...
ax.scatter(
    a_traj["agent-0"][start, 0],
    a_traj["agent-0"][start, 1],
    label="start loc",
    marker='x',
    color='black',
    # edgecolors="black",
...
for jj in range(num_targets):
    ax.scatter(
        t_traj["targ-%d" % jj][start, 0],
        t_traj["targ-%d" % jj][start, 1],
        # color=colors[jj],
        color='black',
        # label="start loc",
        marker='x',
